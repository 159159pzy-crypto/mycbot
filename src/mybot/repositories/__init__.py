...
moderation_audit_table = sa.Table(
    "moderation_audit",
    metadata,
    sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
    ...
    sa.Column("action", sa.Text(), nullable=False),
    sa.Column("preset_response", sa.Text(), nullable=True),
    sa.Column("reason", sa.Text(), nullable=False),
...
tool_approval_request_table = sa.Table(
...
evaluation_run_table = sa.Table(
    ...
    sa.Column("profile_id", postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column("persona_version_id", postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column("model_channel", sa.Text(), nullable=True),
...
evaluation_result_table = sa.Table(
    "evaluation_result",
    metadata,
    sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
...
message_feedback_table = sa.Table(
    "message_feedback",
    metadata,
    sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
